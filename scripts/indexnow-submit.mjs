/**
 * IndexNow bulk submission — pings Bing, Yandex, Seznam, Naver et al. instantly.
 *
 * Reads the live sitemap and submits every URL. IndexNow accepts up to 10,000
 * URLs per request; we batch at 10,000 to stay well inside the limit and to
 * keep working as the directory grows.
 *
 * Usage: node scripts/indexnow-submit.mjs [--cities-only]
 *   --cities-only  submit just the /states/*/* city pages (the money pages)
 */
